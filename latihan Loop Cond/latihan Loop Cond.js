...
for (let z = 0; z < postGraduate.length; z++) {
    console.log("Nama : " + postGraduate[z].name + "\nkeahlian : " + postGraduate[z].mastery)
}
console.log("Mahasiswa S1")
for (let y = 0; y < bachelorDegree.length; y++) {
    console.log("Nama : " + bachelorDegree[y].name + "\nGPA : " + bachelorDegree[y].GPA)
}
